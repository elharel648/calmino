...
// Sound file imports
const soundFiles = {
    lullaby1: require('../assets/sounds/lullaby.m4a'),
    lullaby2: require('../assets/sounds/gentle.m4a'),
    lullaby3: require('../assets/sounds/birds.m4a'),
    lullaby4: require('../assets/sounds/rain.m4a'),
};
