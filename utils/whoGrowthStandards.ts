 ...
 * 
 * Data verified against official WHO tables (March 2026).
 * 
...
// Boys - Weight for age (kg) — WHO 2006
const boysWeight: Record<number, PercentileData> = {
    0: { p3: 2.5, p15: 2.9, p50: 3.3, p85: 3.9, p97: 4.3 },
    1: { p3: 3.4, p15: 3.9, p50: 4.5, p85: 5.2, p97: 5.7 },
    2: { p3: 4.3, p15: 4.9, p50: 5.6, p85: 6.5, p97: 7.1 },
    3: { p3: 5.0, p15: 5.7, p50: 6.4, p85: 7.4, p97: 8.1 },
    4: { p3: 5.6, p15: 6.3, p50: 7.0, p85: 8.1, p97: 8.8 },
    5: { p3: 6.0, p15: 6.8, p50: 7.5, p85: 8.6, p97: 9.3 },
    6: { p3: 6.4, p15: 7.2, p50: 7.9, p85: 9.1, p97: 9.8 },
    7: { p3: 6.7, p15: 7.5, p50: 8.3, p85: 9.5, p97: 10.2 },
    8: { p3: 6.9, p15: 7.8, p50: 8.6, p85: 9.8, p97: 10.5 },
    9: { p3: 7.2, p15: 8.0, p50: 8.9, p85: 10.1, p97: 10.8 },
    10: { p3: 7.4, p15: 8.3, p50: 9.2, p85: 10.4, p97: 11.1 },
    11: { p3: 7.6, p15: 8.5, p50: 9.4, p85: 10.7, p97: 11.4 },
    12: { p3: 7.8, p15: 8.7, p50: 9.6, p85: 10.9, p97: 11.7 },
    13: { p3: 7.9, p15: 8.9, p50: 9.8, p85: 11.1, p97: 11.9 },
    14: { p3: 8.1, p15: 9.0, p50: 10.0, p85: 11.3, p97: 12.1 },
    15: { p3: 8.2, p15: 9.2, p50: 10.2, p85: 11.5, p97: 12.3 },
    16: { p3: 8.4, p15: 9.3, p50: 10.4, p85: 11.7, p97: 12.5 },
    17: { p3: 8.5, p15: 9.5, p50: 10.5, p85: 11.9, p97: 12.7 },
    18: { p3: 8.7, p15: 9.7, p50: 10.7, p85: 12.1, p97: 12.9 },
    19: { p3: 8.8, p15: 9.8, p50: 10.9, p85: 12.3, p97: 13.1 },
    20: { p3: 9.0, p15: 10.0, p50: 11.1, p85: 12.5, p97: 13.3 },
    21: { p3: 9.1, p15: 10.1, p50: 11.2, p85: 12.7, p97: 13.5 },
    22: { p3: 9.2, p15: 10.3, p50: 11.4, p85: 12.9, p97: 13.7 },
    23: { p3: 9.3, p15: 10.5, p50: 11.6, p85: 13.1, p97: 13.9 },
    24: { p3: 9.5, p15: 10.6, p50: 11.8, p85: 13.4, p97: 14.2 },
};

// Boys - Length for age (cm) — WHO 2006
...
// Boys - Head circumference for age (cm) — WHO 2006
const boysHead: Record<number, PercentileData> = {
    0: { p3: 32.1, p15: 33.1, p50: 34.5, p85: 35.8, p97: 37.0 },
    1: { p3: 35.1, p15: 36.1, p50: 37.3, p85: 38.5, p97: 39.5 },
    2: { p3: 36.9, p15: 37.9, p50: 39.1, p85: 40.3, p97: 41.3 },
...
// Girls - Weight for age (kg) — WHO 2006
const girlsWeight: Record<number, PercentileData> = {
    0: { p3: 2.3, p15: 2.7, p50: 3.3, p85: 4.0, p97: 4.6 },
    1: { p3: 3.1, p15: 3.6, p50: 4.2, p85: 5.0, p97: 5.7 },
    2: { p3: 3.9, p15: 4.4, p50: 5.1, p85: 6.0, p97: 6.8 },
    3: { p3: 4.5, p15: 5.0, p50: 5.8, p85: 6.7, p97: 7.6 },
    4: { p3: 5.0, p15: 5.6, p50: 6.4, p85: 7.4, p97: 8.3 },
    5: { p3: 5.4, p15: 6.0, p50: 6.9, p85: 7.8, p97: 8.8 },
    6: { p3: 5.7, p15: 6.3, p50: 7.3, p85: 8.3, p97: 9.3 },
    7: { p3: 5.9, p15: 6.6, p50: 7.6, p85: 8.6, p97: 9.6 },
    8: { p3: 6.2, p15: 6.8, p50: 7.9, p85: 8.9, p97: 9.9 },
    9: { p3: 6.4, p15: 7.0, p50: 8.1, p85: 9.2, p97: 10.2 },
    10: { p3: 6.6, p15: 7.3, p50: 8.4, p85: 9.4, p97: 10.5 },
    11: { p3: 6.8, p15: 7.5, p50: 8.6, p85: 9.7, p97: 10.8 },
    12: { p3: 6.9, p15: 7.7, p50: 8.8, p85: 9.9, p97: 11.0 },
    13: { p3: 7.1, p15: 7.8, p50: 9.0, p85: 10.1, p97: 11.3 },
    14: { p3: 7.2, p15: 8.0, p50: 9.2, p85: 10.3, p97: 11.5 },
    15: { p3: 7.4, p15: 8.2, p50: 9.4, p85: 10.5, p97: 11.7 },
    16: { p3: 7.5, p15: 8.3, p50: 9.5, p85: 10.7, p97: 11.9 },
    17: { p3: 7.6, p15: 8.5, p50: 9.7, p85: 10.9, p97: 12.1 },
    18: { p3: 7.7, p15: 8.6, p50: 9.9, p85: 11.0, p97: 12.3 },
    19: { p3: 7.9, p15: 8.8, p50: 10.0, p85: 11.2, p97: 12.5 },
    20: { p3: 8.0, p15: 8.9, p50: 10.2, p85: 11.4, p97: 12.7 },
    21: { p3: 8.1, p15: 9.0, p50: 10.3, p85: 11.6, p97: 12.9 },
    22: { p3: 8.2, p15: 9.2, p50: 10.5, p85: 11.7, p97: 13.0 },
    23: { p3: 8.3, p15: 9.3, p50: 10.6, p85: 11.9, p97: 13.2 },
    24: { p3: 8.5, p15: 9.4, p50: 10.8, p85: 12.0, p97: 13.4 },
};

// Girls - Length for age (cm) — WHO 2006
...
// Girls - Head circumference for age (cm) — WHO 2006
const girlsHead: Record<number, PercentileData> = {
    0: { p3: 31.9, p15: 32.9, p50: 33.9, p85: 34.9, p97: 35.8 },
    1: { p3: 34.5, p15: 35.5, p50: 36.6, p85: 37.6, p97: 38.6 },
    2: { p3: 36.2, p15: 37.2, p50: 38.3, p85: 39.4, p97: 40.4 },
    3: { p3: 37.5, p15: 38.5, p50: 39.7, p85: 40.8, p97: 41.9 },
    4: { p3: 38.5, p15: 39.6, p50: 40.7, p85: 41.9, p97: 42.9 },
    5: { p3: 39.3, p15: 40.4, p50: 41.6, p85: 42.7, p97: 43.8 },
    6: { p3: 40.0, p15: 41.0, p50: 42.2, p85: 43.4, p97: 44.5 },
    7: { p3: 40.5, p15: 41.6, p50: 42.8, p85: 44.0, p97: 45.1 },
    8: { p3: 41.0, p15: 42.1, p50: 43.3, p85: 44.5, p97: 45.7 },
    9: { p3: 41.4, p15: 42.5, p50: 43.7, p85: 45.0, p97: 46.2 },
    10: { p3: 41.8, p15: 42.9, p50: 44.1, p85: 45.4, p97: 46.6 },
    11: { p3: 42.1, p15: 43.2, p50: 44.5, p85: 45.8, p97: 47.0 },
    12: { p3: 42.4, p15: 43.5, p50: 44.8, p85: 46.1, p97: 47.3 },
    13: { p3: 42.6, p15: 43.8, p50: 45.0, p85: 46.4, p97: 47.6 },
    14: { p3: 42.9, p15: 44.0, p50: 45.3, p85: 46.6, p97: 47.9 },
    15: { p3: 43.1, p15: 44.2, p50: 45.5, p85: 46.8, p97: 48.1 },
    16: { p3: 43.3, p15: 44.4, p50: 45.7, p85: 47.0, p97: 48.3 },
    17: { p3: 43.4, p15: 44.6, p50: 45.9, p85: 47.2, p97: 48.5 },
    18: { p3: 43.6, p15: 44.7, p50: 46.0, p85: 47.4, p97: 48.7 },
    19: { p3: 43.8, p15: 44.9, p50: 46.2, p85: 47.6, p97: 48.8 },
    20: { p3: 43.9, p15: 45.0, p50: 46.3, p85: 47.7, p97: 49.0 },
    21: { p3: 44.0, p15: 45.2, p50: 46.5, p85: 47.9, p97: 49.1 },
    22: { p3: 44.2, p15: 45.3, p50: 46.6, p85: 48.0, p97: 49.2 },
    23: { p3: 44.3, p15: 45.4, p50: 46.7, p85: 48.1, p97: 49.4 },
    24: { p3: 44.4, p15: 45.5, p50: 46.8, p85: 48.2, p97: 49.5 },
};
