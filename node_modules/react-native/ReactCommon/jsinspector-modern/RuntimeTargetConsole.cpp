...
using ConsoleMethodBody = std::function<
    void(
        jsi::Runtime& /*runtime*/,
...
using HostFunctionCallable = std::function<
    jsi::Value(
        jsi::Runtime& /*runtime*/,
...
void RuntimeTarget::installConsoleHandler() {
  ...
  jsExecutor_([selfWeak = weak_from_this(),
    ...
    auto delegateExecutorSync =
        [selfWeak, selfExecutor](std::function<void(RuntimeTargetDelegate&)> func) {
      ...
      console.setProperty(
          ...
          jsi::Function::createFromHostFunction(
              ...
              forwardToOriginalConsole(
                  methodName,
                  HostFunctionCallable([body, state, delegateExecutorSync](
                      jsi::Runtime& runtime,
                      const jsi::Value& /*thisVal*/,
                      const jsi::Value* args,
                      size_t count) -> jsi::Value {
                    auto timestampMs = getTimestampMs();
                    delegateExecutorSync(std::function<void(RuntimeTargetDelegate&)>([&](auto& runtimeTargetDelegate) {
