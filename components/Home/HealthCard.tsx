...
const createStyles = (theme: any) => StyleSheet.create({
    ...
    cardText: { flex: 1, marginRight: SPACING.md + 2, alignItems: 'flex-end' },
    cardTitle: { ...TYPOGRAPHY.bodyLarge, fontWeight: '700', color: theme.textPrimary },
    cardSubtitle: { ...TYPOGRAPHY.caption, color: theme.textSecondary, marginTop: 2 },
    cardArrow: { opacity: 0.6 },

    modalOverlay: { flex: 1, backgroundColor: theme.modalOverlay, justifyContent: 'flex-end' },
    modalContent: { backgroundColor: theme.card, borderTopLeftRadius: BORDER_RADIUS.xxl, borderTopRightRadius: BORDER_RADIUS.xxl, height: '90%', overflow: 'hidden', ...SHADOWS.prominent },
    dragHandle: { alignItems: 'center', paddingTop: SPACING.md + 2, paddingBottom: SPACING.md, zIndex: 10 },
    dragHandleBar: { width: 36, height: 5, borderRadius: BORDER_RADIUS.xs - 1 },
    modalHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: SPACING.lg, paddingTop: SPACING.lg, paddingBottom: SPACING.md, borderBottomWidth: 1, borderBottomColor: theme.border },
    headerBtn: { padding: SPACING.sm, backgroundColor: theme.cardBackground, borderRadius: BORDER_RADIUS.md + 2 },
    headerTitleContainer: { flex: 1, alignItems: 'center', justifyContent: 'center', flexDirection: 'column' },
    headerIconWrapper: { marginBottom: SPACING.sm, alignItems: 'center' },
    headerIconCircle: {
        width: 56,
        height: 56,
    ...
    modalTitle: { ...TYPOGRAPHY.bodyLarge, fontWeight: '600', color: '#1F2937' },
    modalBody: { flex: 1, backgroundColor: '#FFFFFF' },

    menuContainer: { padding: SPACING.lg },
    optionsList: { gap: SPACING.sm + 2 },
    optionRow: {
        flexDirection: 'row-reverse',
        alignItems: 'center',
    ...
    optionLabel: { flex: 1, ...TYPOGRAPHY.bodySmall, fontWeight: '600', color: '#374151', textAlign: 'right' },

    screenContent: { padding: SPACING.xxxl, paddingBottom: SPACING.huge },
    screenHeader: { alignItems: 'center', marginBottom: SPACING.lg },
    screenHeaderIcon: { width: 72, height: 72, borderRadius: BORDER_RADIUS.xxl, alignItems: 'center', justifyContent: 'center' },
    screenHeaderIconMinimal: { width: 56, height: 56, borderRadius: BORDER_RADIUS.round, backgroundColor: '#F9FAFB', borderWidth: 1, borderColor: '#E5E7EB', alignItems: 'center', justifyContent: 'center' },
    screenSubtitle: { ...TYPOGRAPHY.labelSmall, color: '#9CA3AF', marginTop: SPACING.sm + 2 },

    // Vaccine styles
    addVaccineBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: SPACING.sm, backgroundColor: '#EEF2FF', padding: SPACING.md + 2, borderRadius: SPACING.md + 2, marginBottom: SPACING.xxxl },
    addVaccineBtnText: { ...TYPOGRAPHY.bodySmall, fontWeight: '600', color: '#6366F1' },
    addVaccineForm: { flexDirection: 'row-reverse', gap: SPACING.sm + 2, marginBottom: SPACING.xxxl },
    addVaccineInput: { flex: 1, backgroundColor: '#fff', borderRadius: BORDER_RADIUS.lg, padding: SPACING.md + 2, ...TYPOGRAPHY.bodySmall, textAlign: 'right', textAlignVertical: 'center', borderWidth: 1, borderColor: '#E5E7EB', writingDirection: 'rtl' },
    addVaccineSubmit: { width: 48, height: 48, borderRadius: BORDER_RADIUS.lg, backgroundColor: '#6366F1', alignItems: 'center', justifyContent: 'center' },
    vaccineGroup: { marginBottom: SPACING.xxxl },
    ageBadge: { alignSelf: 'flex-end', paddingHorizontal: SPACING.lg, paddingVertical: SPACING.sm, borderRadius: BORDER_RADIUS.xl, marginBottom: SPACING.md },
    ageBadgeText: { color: '#fff', fontWeight: '700', ...TYPOGRAPHY.label },
    ageBadgeMinimal: { alignSelf: 'flex-end', paddingHorizontal: SPACING.md + 2, paddingVertical: SPACING.xs + 2, borderRadius: BORDER_RADIUS.xl, marginBottom: SPACING.sm + 2, backgroundColor: '#F9FAFB', borderWidth: 1, borderColor: '#E5E7EB' },
    ageBadgeTextMinimal: { color: '#6B7280', fontWeight: '600', ...TYPOGRAPHY.labelSmall },
    vaccineRow: { flexDirection: 'row-reverse', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#fff', padding: SPACING.lg, borderRadius: BORDER_RADIUS.xl, marginBottom: SPACING.sm, ...SHADOWS.subtle },
    vaccineRowDone: { flexDirection: 'row-reverse', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#F0FDF4', padding: SPACING.lg, borderRadius: BORDER_RADIUS.xl, marginBottom: SPACING.sm, borderWidth: 1, borderColor: '#10B981' },
    vaccineName: { ...TYPOGRAPHY.bodySmall, color: '#1F2937', fontWeight: '500', textAlign: 'right', writingDirection: 'rtl' },
    vaccineNameDone: { ...TYPOGRAPHY.bodySmall, color: '#10B981', fontWeight: '600', textDecorationLine: 'line-through', textAlign: 'right', writingDirection: 'rtl' },
    checkbox: { width: 26, height: 26, borderRadius: BORDER_RADIUS.sm, borderWidth: 2, borderColor: '#D1D5DB', alignItems: 'center', justifyContent: 'center' },
    checkboxChecked: { backgroundColor: '#10B981', borderColor: '#10B981' },

    // Temperature slider
    temperatureDisplay: { backgroundColor: '#fff', borderRadius: BORDER_RADIUS.xl, padding: SPACING.xxxl, alignItems: 'center', borderWidth: 3, marginBottom: SPACING.xxxl },
    temperatureValue: { fontSize: 64, fontWeight: '800' },
    temperatureUnit: { fontSize: 24, color: '#6B7280', marginTop: -SPACING.sm },
    temperatureDisplayMinimal: { backgroundColor: '#F9FAFB', borderRadius: BORDER_RADIUS.xl, padding: SPACING.xxl, alignItems: 'center', marginBottom: SPACING.xxxl },
    temperatureValueMinimal: { fontSize: 56, fontWeight: '700', color: '#374151' },
    temperatureUnitMinimal: { fontSize: 20, color: '#9CA3AF', marginTop: -SPACING.xs },
    quickSelectBtnMinimal: { paddingVertical: SPACING.sm + 2, paddingHorizontal: SPACING.lg, borderRadius: BORDER_RADIUS.xl, backgroundColor: '#F3F4F6', marginRight: SPACING.sm, marginBottom: SPACING.sm },
    quickSelectBtnMinimalActive: { backgroundColor: '#E5E7EB' },
    quickSelectTextMinimal: { ...TYPOGRAPHY.label, fontWeight: '500', color: '#6B7280' },
    quickSelectTextMinimalActive: { color: '#374151', fontWeight: '600' },
    sliderContainer: { flexDirection: 'row', alignItems: 'center', marginBottom: SPACING.xxxl },
    sliderBtn: { width: 44, height: 44, borderRadius: BORDER_RADIUS.round, backgroundColor: '#fff', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#E5E7EB' },
    slider: { flex: 1, marginHorizontal: SPACING.sm + 2, height: 40 },

    // Forms
    inputGroup: { marginBottom: SPACING.xxxl },
    inputLabel: { ...TYPOGRAPHY.label, color: '#374151', marginBottom: SPACING.sm, textAlign: 'right' },
    textInput: { backgroundColor: '#fff', borderRadius: BORDER_RADIUS.xl, padding: SPACING.lg, ...TYPOGRAPHY.body, textAlign: 'right', borderWidth: 1, borderColor: '#E5E7EB' },
    textArea: { backgroundColor: '#fff', borderRadius: BORDER_RADIUS.xl, padding: SPACING.lg, ...TYPOGRAPHY.body, textAlign: 'right', borderWidth: 1, borderColor: '#E5E7EB', minHeight: 100, textAlignVertical: 'top' },
    quickSelectRow: { flexDirection: 'row', flexWrap: 'wrap', gap: SPACING.sm, marginBottom: SPACING.xxxl },
    quickSelectRowRTL: { flexDirection: 'row-reverse', flexWrap: 'wrap', justifyContent: 'flex-start', gap: SPACING.sm, marginBottom: SPACING.xxxl },
    quickSelectBtn: { paddingHorizontal: SPACING.lg, paddingVertical: SPACING.sm + 2, backgroundColor: '#fff', borderRadius: BORDER_RADIUS.xl, borderWidth: 1, borderColor: '#E5E7EB' },
    quickSelectBtnActive: { backgroundColor: '#F59E0B', borderColor: '#F59E0B' },
    quickSelectBtnWarning: { borderColor: '#EF4444' },
    quickSelectText: { ...TYPOGRAPHY.label, color: '#374151' },
    quickSelectTextActive: { color: '#fff' },

    // Upload
    uploadSection: { flexDirection: 'row', gap: SPACING.md, marginBottom: SPACING.xxl },
    uploadButton: { flex: 1, backgroundColor: '#fff', borderRadius: BORDER_RADIUS.xl, padding: SPACING.lg, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#E5E7EB', minHeight: 100 },
    uploadButtonSuccess: { backgroundColor: '#F0FDF4', borderColor: '#10B981' },
    uploadButtonText: { ...TYPOGRAPHY.label, color: '#6B7280', marginTop: SPACING.sm, fontWeight: '500' },
    uploadButtonTextSuccess: { ...TYPOGRAPHY.caption, color: '#10B981', marginTop: SPACING.sm, fontWeight: '600' },
    uploadPreview: { width: 50, height: 50, borderRadius: BORDER_RADIUS.sm },

    // Chips
    sectionTitle: { ...TYPOGRAPHY.bodySmall, fontWeight: '600', color: '#374151', marginBottom: SPACING.md, textAlign: 'right' },
    chipsContainer: { flexDirection: 'row', flexWrap: 'wrap', gap: SPACING.sm, marginBottom: SPACING.xxl },
    chipsContainerRTL: { flexDirection: 'row-reverse', flexWrap: 'wrap', gap: SPACING.sm, marginBottom: SPACING.lg },
    chip: { paddingHorizontal: SPACING.lg, paddingVertical: SPACING.sm + 2, backgroundColor: '#F9FAFB', borderRadius: BORDER_RADIUS.xl, borderWidth: 1, borderColor: '#E5E7EB' },
    chipPlus: { paddingHorizontal: SPACING.md, paddingVertical: SPACING.sm + 2 },
    chipActive: { backgroundColor: '#EF4444', borderColor: '#EF4444' },
    chipActivePurple: { backgroundColor: '#8B5CF6', borderColor: '#8B5CF6' },
    chipText: { ...TYPOGRAPHY.label, fontWeight: '500', color: '#374151' },
    chipTextActive: { color: '#fff' },

    saveButton: { marginTop: SPACING.lg },
    saveButtonSolid: { paddingVertical: SPACING.md, paddingHorizontal: SPACING.xxl, borderRadius: BORDER_RADIUS.xxl, alignItems: 'center', backgroundColor: '#F9FAFB', borderWidth: 1, borderColor: '#E5E7EB' },
    saveButtonSuccess: { backgroundColor: '#ECFDF5', borderColor: '#10B981' },
    saveButtonText: { ...TYPOGRAPHY.bodySmall, fontWeight: '600', color: '#374151' },
});
